...
export default function CurrencyEdit({ currency }: Props) {
  ...
  return (
    <AppLayout title={`Edit Currency: ${currency.code}`}>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="px-6 py-5">
          <h3 className="text-lg leading-6 font-medium text-gray-900">Edit Currency</h3>
          <p className="mt-1 text-sm text-gray-500">
            Update the details for {currency.name} ({currency.code}).
          </p>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-6">
            <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
              ...
              <div className="sm:col-span-4">
                ...
                <p className="mt-1 text-xs text-gray-500">
                  {data.is_default
                    ? "The exchange rate for the default currency is always 1."
                  ...
                  <div className="ml-3 text-sm">
                    <label
                      ...
                      className={`font-medium flex items-center ${
                        data.is_default ? 'text-gray-500' : 'text-gray-700'
                      }`}
                    >
                    ...
                    <p className="text-gray-500">
                      {data.is_default
                        ? "This is already the default currency."
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-700">
                    ...
                    <p className="mt-2">
                      The exchange rate should be set relative to the default currency in your system.
                      {data.is_default && " Since this is the default currency, the exchange rate is fixed at 1."}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              ...
              <p className="mt-2">
                <strong>Exchange Rate:</strong> The exchange rate determines how this currency will be converted to and from the default currency. For the default currency itself, the exchange rate is always 1.
              </p>
              <p className="mt-2">
