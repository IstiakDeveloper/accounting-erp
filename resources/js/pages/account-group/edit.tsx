...
export default function AccountGroupEdit({ account_group, parent_groups, natures }: Props) {
    const { data, setData, put, processing, errors } = useForm<{
        ...
        nature: account_group.nature,
        affects_gross_profit: account_group.affects_gross_profit,
    ...
    // Original nature to detect changes
    const [originalNature] = useState(account_group.nature);

    // Flag to show nature change warning
    const [showNatureWarning, setShowNatureWarning] = useState(false);

    // Update parent nature when parent changes
    useEffect(() => {
        if (data.parent_id) {
    ...
    // Show warning when nature changes
    useEffect(() => {
        setShowNatureWarning(data.nature !== originalNature);
    }, [data.nature, originalNature]);

    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        put(route('account_group.update', account_group.id));
    };
    ...
    return (
        <AppLayout title="Edit Account Group">
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
                <div className="px-4 py-5 sm:p-6">
                    <h3 className="text-lg font-medium leading-6 text-slate-900">Edit Account Group</h3>
                    <p className="mt-1 text-sm text-slate-500">
                        Update the structure and behavior of this account group.
                    </p>

                    {/* Nature change warning */}
                    {showNatureWarning && (
                            ...
                            <div className="flex">
                                ...
                                <div className="ml-3">
                                    ...
                                    <div className="mt-2 text-sm text-amber-700">
                                        <p>
                                            Changing the nature of this account group will also update all of its sub-groups to the same nature.
                                            This can significantly impact your financial reporting.
                                        </p>
                                    </div>
                                </div>
                            </div>
