...
export default function VoucherDuplicate({
  voucher,
  original_voucher,
  voucher_type,
  financial_year,
  ...
  return (
    <AppLayout title="Duplicate Voucher">
      <Head title="Duplicate Voucher" />

      <div className="mb-6">
        <Link
          href={route('voucher.show', original_voucher.id)}
          className="inline-flex items-center text-sm text-blue-600 hover:text-blue-700"
        >
          <ChevronLeft className="w-4 h-4 mr-1" />
          Back to Original Voucher
        </Link>
      </div>
        ...
        <div className="px-4 py-5 sm:p-6">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
              ...
              From {original_voucher.voucher_type.name} #{original_voucher.voucher_number}
            </span>
          </div>

          <p className="mt-1 text-sm text-slate-500">
            Create a new voucher based on an existing one. You can modify the details as needed.
          </p>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-8">
            ...
            <div className="flex justify-end pt-5">
              ...
              >
                {processing ? 'Creating...' : 'Create Duplicate Voucher'}
              </button>
            </div>
          </form>
        </div>
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg">
        <div className="flex">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-blue-800">About Duplicating Vouchers</h3>
            <div className="mt-2 text-sm text-blue-700">
              <ul className="list-disc space-y-1 pl-5">
                <li>Duplicating a voucher creates a new voucher with the same accounts and amounts.</li>
                <li>You can modify any details in the duplicated voucher before saving it.</li>
                <li>This is useful for creating recurring transactions or correcting errors in previous vouchers.</li>
                <li>A new voucher number is automatically assigned from the current financial year.</li>
                <li>The duplicated voucher will not be linked to the original for tracking purposes.</li>
              </ul>
            </div>
          </div>
        </div>
