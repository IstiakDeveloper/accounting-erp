...
export default function Dashboard({
    ...
    return (
        <AppLayout title="Dashboard">
            ...
            <div className="mb-6">
                <h1 className="text-2xl font-semibold text-slate-800">{businessD.name}</h1>
                <p className="text-sm text-slate-500">
                    Financial Year: {new Date(financialYearD.start_date).toLocaleDateString('en-BD', {
                        day: '2-digit',
                        month: '2-digit',
                        year: 'numeric'
                    })} to {new Date(financialYearD.end_date).toLocaleDateString('en-BD', {
                        day: '2-digit',
                        month: '2-digit',
                        year: 'numeric'
                    })}
                    {financialYearD.is_locked && ' (Locked)'}
                </p>
            </div>
